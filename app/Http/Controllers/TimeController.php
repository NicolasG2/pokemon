...
class TimeController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($team as $t) {
            ...
            $treinador = Treinador::find($t->id_treinador);

            if ($treinador) {
                $dado[$cont]['nome_treinador'] = $treinador->nome;
            } else {
                $dado[$cont]['nome_treinador'] = "Treinador não encontrado";
            }
        }
        ...
        return view('time.index', compact('data', 'dado'));
    }
    ...
    public function edit($id)
    {
        ...
        $treinadores = Treinador::orderBy('id')->get();

        if(isset($team->id_treinador)) {
            $dado['id_treinador'] = Treinador::find($team->id_treinador)->nome;
        }

        return view('time.edit', compact('data', 'poks', 'dado', 'treinadores'));
    }
