@extends('template.main', [
    ...
    'submenu' => 'Tipos',
    'rota' => "tipo.create",
    'permission' => isset($permissions['tipo.create']) ? $permissions['tipo.create'] : null
])
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                @if(isset($permissions['tipo.edit']) && $permissions['tipo.edit'])
                                    <a href="{{ route('tipo.edit', $item['id']) }}" class="btn btn-success">
                                ...
                                @endif
                                @if(isset($permissions['tipo.destroy']) && $permissions['tipo.destroy'])
