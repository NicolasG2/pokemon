...
<form action="{{ route('time.update', $data['id']) }}" method="POST">
    ...
    <div class="row">
        <div class="col">
            <label for="id_treinador">Treinador</label>
            <div class="form mb-3">
                <select class="form-control @if($errors->has('id_treinador')) is-invalid @endif" name="id_treinador" placeholder="Treinador">
                    <option value="">Selecione um treinador</option>
                    @foreach($treinadores as $treinador)
                        <option value="{{ $treinador->id }}" @if($treinador->id == $dado['id_treinador']) selected @endif>
                            {{ $treinador->nome }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="col">
            ...
            <div class="form mb-3">
                <select class="form-control @if($errors->has('pokemon1')) is-invalid @endif" name="pokemon1" placeholder="Pokémon 1">
                    ...
                    @foreach($poks as $pok)
                        <option value="{{ $pok->id }}" @if($pok->id == $data['pokemon1']) selected @endif>
                            {{ $pok->nome }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="col">
            ...
            <div class="form mb-3">
                <select class="form-control" name="pokemon2" placeholder="Pokémon 2">
                    <option value="">Selecione um pokémon</option>
                    @foreach($poks as $pok)
                        <option value="{{ $pok->id }}" @if($pok->id == $data['pokemon2']) selected @endif>
                            {{ $pok->nome }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="col">
            ...
            <div class="form mb-3">
                <select class="form-control" name="pokemon3" placeholder="Pokémon 3">
                    <option value="">Selecione um pokémon</option>
                    @foreach($poks as $pok)
                        <option value="{{ $pok->id }}" @if($pok->id == $data['pokemon3']) selected @endif>
                            {{ $pok->nome }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="col">
            ...
            <div class="form mb-3">
                <select class="form-control" name="pokemon4" placeholder="Pokémon 4">
                    <option value="">Selecione um pokémon</option>
                    @foreach($poks as $pok)
                        <option value="{{ $pok->id }}" @if($pok->id == $data['pokemon4']) selected @endif>
                            {{ $pok->nome }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="col">
            ...
            <div class="form mb-3">
                <select class="form-control" name="pokemon5" placeholder="Pokémon 5">
                    <option value="">Selecione um pokémon</option>
                    @foreach($poks as $pok)
                        <option value="{{ $pok->id }}" @if($pok->id == $data['pokemon5']) selected @endif>
                            {{ $pok->nome }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="col">
            ...
            <div class="form mb-3">
                <select class="form-control" name="pokemon6" placeholder="Pokémon 6">
                    <option value="">Selecione um pokémon</option>
                    @foreach($poks as $pok)
                        <option value="{{ $pok->id }}" @if($pok->id == $data['pokemon6']) selected @endif>
                            {{ $pok->nome }}
                        </option>
                    @endforeach
                </select>
