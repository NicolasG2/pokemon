            ...
            <div class="col">
                ...
                <div class="form-check">
                    <input type="radio" id="garoto" name="genero" value="0"
                        @if (old('genero', $dados->genero) == 0) checked @endif>
                    <label for="garoto">Garoto</label><br>
                    <img class="label_img" src="../img/brendan.png">
                </div>
                <div class="form-check">
                    <input type="radio" id="garota" name="genero" value="1"
                        @if (old('genero', $dados->genero) == 1) checked @endif> 
                    <label for="garota">Garota</label><br>
                    <img class="label_img" src="../img/may.png">
                </div>
